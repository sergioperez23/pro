...
public class RankingJ1 extends JFrame {
	...
	private JLabel lblRnkingadivinaQuin;
	 ...
	 */
	public static void RankingAdivinaQuien() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RankingJ1 frame = new RankingJ1();
	...
	public RankingJ1() {
		...
		String nom1 = "";					//Creamos variables para los campos de nombre y puntuación
		String nom2 = "";
		String nom3 = "";
		String nom4 = "";
		String nom5 = "";
		...
		//Seleccionamos cada puesto de la BBDD, su nombre y puntuación
		
		/*                    RANKING ARREGLADO                      ************************************/
		String puesto1 = "SELECT * FROM proyectoprog.ranking ORDER BY PUNTUACION DESC, NICK DESC LIMIT 0,1";
		...
		String puesto2 = "SELECT * FROM proyectoprog.ranking ORDER BY PUNTUACION DESC, NICK DESC LIMIT 1,1";
		...
		String puesto3 = "SELECT * FROM proyectoprog.ranking ORDER BY PUNTUACION DESC, NICK DESC LIMIT 2,1";
		...
		String puesto4 = "SELECT * FROM proyectoprog.ranking ORDER BY PUNTUACION DESC, NICK DESC LIMIT 3,1";
		...
		String puesto5 = "SELECT * FROM proyectoprog.ranking ORDER BY PUNTUACION DESC, NICK DESC LIMIT 4,1";
		...
		lblRnkingadivinaQuin = new JLabel("RANKING \"ADIVINA QUIÉN\"");
		lblRnkingadivinaQuin.setHorizontalAlignment(SwingConstants.CENTER);
		lblRnkingadivinaQuin.setForeground(SystemColor.menu);
		lblRnkingadivinaQuin.setFont(new Font("Gill Sans MT", Font.BOLD | Font.ITALIC, 29));
		lblRnkingadivinaQuin.setBounds(0, 26, 718, 46);
		contentPane.add(lblRnkingadivinaQuin);
		...
		lblNombre1_1.setBounds(59, 286, 173, 28);
		...
		lblScore1_1.setBounds(59, 308, 173, 28);
		...
		lblNombre1_2.setBounds(480, 286, 173, 28);
		...
		lblScore1_2.setBounds(480, 308, 173, 28);
